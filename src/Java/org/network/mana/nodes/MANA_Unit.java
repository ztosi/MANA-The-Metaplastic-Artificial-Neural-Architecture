...
public class MANA_Unit {
	...
	public ConnectSpecs defInpCS = new ConnectSpecs(ConnectRule.Random,
			new double[]{1}, Utils.ProbDistType.NORMAL, new double[]{0.5, 0.125}, 2000, SynapseData.MAX_DELAY);
	public ConnectSpecs defInpCS2 = new ConnectSpecs(ConnectRule.Random,
			new double[]{0.2}, Utils.ProbDistType.NORMAL, new double[]{2, 0.5}, 2000, SynapseData.MAX_DELAY);
	public ConnectSpecs defInpCSInh = new ConnectSpecs(ConnectRule.Random,
			new double[]{0.1}, Utils.ProbDistType.NORMAL, new double[]{1, 0.5}, 2000, SynapseData.MAX_DELAY);
