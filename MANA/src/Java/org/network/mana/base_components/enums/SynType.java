...
public enum SynType {
    ...
    public static final double eiTauMinus = 60;
    ...
    public static final double ieWMinus = 3;
    public static final double iiWPlus = 2;
    public static final double iiWMinus = 8;
